...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" href="resource/img/teddy.png" type="image/x-icon">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <a class="banner banner-1" href="searchbynhomsp.htm?maNhomSp=1">
                            <img src="https://www.sangia.vn/uploads/Image/2020/03/01/G%E1%BA%A5u%20Teddy%20Bear-.jpg" height="300px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="white-color">Gấu Teddy</h2>
                            </div>
                        </a>
                    </div>
                    <!-- /banner -->
                    ...
                    <!-- banner -->
                    <div class="col-md-4 col-sm-6">
                        <a class="banner banner-1" href="searchbynhomsp.htm?maNhomSp=2">
                            <img src="https://toplist.vn/images/800px/gau-bong-123861.jpg" height="300px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="white-color">Gấu Bông Cặp</h2>
                            </div>
                        </a>
                    </div>
                    <!-- /banner -->
                    ...
                    <div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3">
                        <a class="banner banner-1" href="searchbynhomsp.htm?maNhomSp=3">
                            <img src="https://quatangvang247.vn/wp-content/uploads/2019/09/qua-tang-tot-nghiep-2.jpg" height="300px" alt="">
                            <div class="banner-caption text-center">
                                <h2 class="white-color">Gấu Bông Tốt Nghiệp</h2>
                            </div>
                        </a>
                    </div>
                    <!-- /banner -->
    ...
    <div class="section section-grey">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="banner banner-1">
                        <img src="resource/img/banner_sale_off_50percent.webp" alt="">
                        <div class="banner-caption text-center">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="resource/img/new_collection_01.jfif" alt="">
                        <div class="banner-caption text-center">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="resource/img/new_collection_02.jfif" alt="">
                        <div class="banner-caption text-center">
                            <h2 class="white-color">NEW COLLECTION</h2>
                        </div>
                    </a>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="banner banner-2">
                        <img src="resource/img/banner14.jpg" alt="">
